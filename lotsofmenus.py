...
company8 = Company(name="Chevrolet")
session.add(company8)
session.commit()

MenuCars1 = MenuCars(name="Chevrolet",
                     description="The Chevrolet Cruze LS 2017 is a sedan.",
                     price="52,000 SR", company=company8)
session.add(MenuCars1)
session.commit()

MenuCars2 = MenuCars(name="Chevrolet Impala",
...
company9 = Company(name="Infiniti")
session.add(company9)
session.commit()

MenuCars1 = MenuCars(name="Infiniti Excellence",
                     description="Infiniti Q70 Excellence 3.7 2016 is sedan.",
                     price="175,000 SR", company=company9)
session.add(MenuCars1)
session.commit()

MenuCars2 = MenuCars(name="Infiniti Q70 Luxury",
...
company10 = Company(name="GMC")
session.add(company10)
session.commit()

MenuCars1 = MenuCars(name="GMC Yukon SLE",
                     description="The GMC Yukon SLE 2019 is a sports car.",
                     price="188,000 SR", company=company10)
session.add(MenuCars1)
session.commit()

MenuCars2 = MenuCars(name="GMC Yukon SLE 4 in 4",
